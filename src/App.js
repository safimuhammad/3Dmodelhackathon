    ...
    if (prompt.trim() !== '') {
      try {
        ...
        if (contentType === 'application/json') {
          ...
          console.log('Received binary response:', response.data);
    ...
    <div className="body">
            ...
            <div className="wrap-nav-btn">
              <button className="outer-nav-btn w-inline-block" type="button" data-bs-toggle="modal" data-bs-target="#registerModal">
                <div className="inner-nav-btn">
                  <div className="nav-btn-text">Launch Archi</div>
                </div>
              </button>
            </div>
          </div>
      ...
      <div className="section bg-dot wf-section hero-section">
        <div className="container w-container">
          <div className="wrap-text hero-text">
            ...
            <div className="head-subtitle">Use our revolutionary AI-powered design tool to generate photo-like images in seconds.<br />Professionals and individuals can now create unlimited renders of any space.</div>
            <div className="start-here">
              <button className="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#registerModal">Start Designing For Free</button>
        ...
        <div className="before-after">
          ...
          <div>
            ...
            <img src={require("./img/ai-room.jpg")} alt="Interior design generated by Archi AI" width="450" loading="lazy" />
          </div>
        </div>
      </div>
        ...
        <div className="container w-container">
          <div className="wrap-text">
            ...
            <div className="over-hide _w-70">
              <div className="main-subtitle">Start designing your interior or exterior by following these 3 simple steps</div>
            </div>
          </div>
          ...
          <div className="mt-5">
            <div className="gridx-3">

              <div className="wrap-work" id="w-node-b138f47f-476d-a5e3-09b6-fa3918aa032b-2cc6d822">
                <div className="outer-work" data-w-id="6782c266-2c57-8998-09f0-a6fa88a1f2d7">
                  <div className="inner-work">
                    <div className="work-logo">
                      <div className="w-embed">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M38.5 22V29.7C38.5 32.7803 38.5 34.3204 37.9005 35.4969C37.3732 36.5318 36.5318 37.3732 35.4969 37.9005C34.3204 38.5 32.7803 38.5 29.7 38.5H14.3C11.2197 38.5 9.67957 38.5 8.50305 37.9005C7.46816 37.3732 6.62677 36.5318 6.09946 35.4969C5.5 34.3204 5.5 32.7803 5.5 29.7V22M29.3333 12.8333L22 5.5M22 5.5L14.6667 12.8333M22 5.5V27.5" stroke="url(#paint0_linear_1_182)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          <defs>
                            <linearGradient id="paint0_linear_1_182" x1="5.5" y1="22" x2="38.5" y2="22" gradientUnits="userSpaceOnUse">
                              <stop stopColor="#9ED4FC" />
                              <stop offset="1" stopColor="#D081F7" />
                            </linearGradient>
                          </defs>
                    ...
                    <div className="work-text">
                      <h3 className="work-title">Upload a picture of your interior or exterior space</h3>
                      <div className="work-subtitle">Or simply drag and drop your photo.</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="wrap-work" id="w-node-f9e36fac-1597-dc14-e046-66be34f763a6-2cc6d822">
                <div className="outer-work" data-w-id="f9e36fac-1597-dc14-e046-66be34f763a7">
                  <div className="inner-work">
                    <div className="work-logo">
                      <div className="w-embed">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="work-text">
                      <h3 className="work-title">Fill out a short form and select the style you are looking for</h3>
                      <div className="work-subtitle">It's easy to find the right style for you with our online form.</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="wrap-work" id="w-node-_3ba1b718-d1a8-0044-fc6b-39c407dc80c5-2cc6d822">
                <div className="outer-work" data-w-id="3ba1b718-d1a8-0044-fc6b-39c407dc80c6">
                  <div className="inner-work">
                    <div className="work-logo">
                      <div className="w-embed">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="work-text">
                      <h3 className="work-title">Press “Generate” to create different designs of your space</h3>
                      <div className="work-subtitle">Our AI will generate images that perfectly fit your space.</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="section wf-section">
        <div className="container w-container">
          <div className="wrap-text">
            <div className="over-hide">
              <h2 className="main-title">Last Generated Designs</h2>
            </div>
            <div className="over-hide">
              <div className="main-subtitle">These are just a few of the thousands of different designs that Archiʼs system can do.</div>
            </div>
          </div>
          <div className="mt-5 center">
            <div className="grid-design">
              <div className="wrap-img-design"><img src={require("./images/design1.jpeg")} loading="lazy" sizes="(max-width: 767px) 90vw, 29vw" alt="" className="design-img" /></div>
              <div className="wrap-img-design"><img src={require("./images/design3.jpeg")} loading="lazy" sizes="(max-width: 767px) 90vw, 29vw" alt="" className="design-img" /></div>
              <div className="wrap-img-design"><img src={require("./images/design4.jpeg")} loading="lazy" sizes="(max-width: 767px) 90vw, 29vw" alt="" className="design-img" /></div>
              <div className="wrap-img-design"><img src={require("./images/design5.jpeg")} loading="lazy" sizes="(max-width: 767px) 90vw, 29vw" alt="" className="design-img" /></div>
            </div>
            <a href="#" className="outer-nav-btn d-block _w-100 w-inline-block" type="button" data-bs-toggle="modal" data-bs-target="#registerModal">
              <div className="inner-nav-btn">
                <div className="nav-btn-text">See more</div>
                <div className="w-embed"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.06958 4.49197L13.5078 4.49197L13.5078 10.9302" stroke="url(#paint0_linear_1_240)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path d="M4.49219 13.5076L13.4176 4.58214" stroke="url(#paint1_linear_1_240)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <defs>
                    <linearGradient id="paint0_linear_1_240" x1="9.94983" y1="7.37222" x2="13.1136" y2="4.21531" gradientUnits="userSpaceOnUse">
      ...
      <div className="section wf-section" id="features">
        <div className="container w-container">
          <div className="wrap-text">
            <div className="over-hide">
              <h2 className="main-title">Which Rooms Will You Stage?</h2>
            </div>
            <div className="over-hide _w-70">
              <div className="main-subtitle">Create the perfect space with a seamless design process. Let's design your dream home or any space with AI and get the best interior design advices.</div>
            </div>
          </div>
          <div className="mt-5">
            <div data-w-id="32d6f446-0d72-ca80-bdca-df82f5c57f32" style={{ opacity: 10 }} data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100" className="w-tabs">
              <div className="wrap-tab-menu w-tab-menu">
                <a className={`tab-menu w-inline-block w-tab-link ${activeTab === 'Tab 1' ? 'w--current' : ''}`}
                  onClick={() => handleTabClick('Tab 1')}>
                  <div className="tab-menu-text">Living Room</div>
                </a>
                <a className={`tab-menu w-inline-block w-tab-link ${activeTab === 'Tab 2' ? 'w--current' : ''}`}
                  onClick={() => handleTabClick('Tab 2')}>
                  <div className="tab-menu-text">Bedroom</div>
                </a>
                <a className={`tab-menu w-inline-block w-tab-link ${activeTab === 'Tab 3' ? 'w--current' : ''}`}
                  onClick={() => handleTabClick('Tab 3')}>
                  <div className="tab-menu-text">Kitchen</div>
                </a>
                <a className={`tab-menu w-inline-block w-tab-link ${activeTab === 'Tab 4' ? 'w--current' : ''}`}
                  onClick={() => handleTabClick('Tab 4')}>
                  <div className="tab-menu-text">Bathroom</div>
                </a>
                <a className={`tab-menu w-inline-block w-tab-link ${activeTab === 'Tab 5' ? 'w--current' : ''}`}
                  onClick={() => handleTabClick('Tab 5')}>
                  <div className="tab-menu-text">Dining Room</div>
                </a>
                  ...
                  <div className="wrap-tab-content">
                    <div id="w-node-d02a08b5-e077-9f2d-3574-a52026df753a-2cc6d822" className="wrao-tab-content-text">
                      ...
                      <div id="w-node-_19fb8305-c4fb-d49b-a05a-9551ca6dac92-2cc6d822" className="tab-content-subtitle">
                        ...
                        just for you. You simply need to answer a few questions about what you're looking for, and Archi AI will do the rest.
      ...
      <div className="section wf-section">
        <div className="container w-container">
          <div className="wrap-text">
            ...
            <div className="over-hide">
              <h1 className="main-title">Why Choose Archi?</h1>
            </div>
          ...
          <div className="wrap-footer-menu" data-w-id="648f99e2-698e-ce2a-854b-df012cbcfa11">
            <div id="w-node-de161822-281d-e202-6bab-f82fc2f12093-2cc6d822" data-w-id="de161822-281d-e202-6bab-f82fc2f12093" className="footer-menu _w-70">
              <div className="footer-logo">
                <img src={require('./img/logo.svg').default} loading="lazy" alt="" />
              </div>
              <div id="w-node-_3fe3b868-dab9-8ce4-4c5f-786a12343696-2cc6d822" className="footer-text">Automatically generate photo-like images of your desired spaces in seconds. Unleash the most advanced AI interior design tool to boost your productivity.</div>
              <div className="footer-sosmed">
                <a href="https://www.facebook.com/profile.php?id=100093642397434" target="_blank" rel="nofollow" className="sosmed-item w-inline-block">
                  <div className="w-embed">
            ...
            <div className="inner-wrap-footer-menu">
              ...
              <div className="footer-menu" id="w-node-_7f560344-6040-9f5d-1fae-3d286b57ed40-2cc6d822">
                <div className="footer-menu-title">Services</div>
                <a href="#" className="footer-link">Kitchen</a>
                <a href="#" className="footer-link">Bedroom</a>
                <a href="#" className="footer-link">Bathroom</a>
                <a href="#" className="footer-link">Living Room</a>
              </div>
            </div>
          </div>
          <div className="footer-label">
            <div className="footer-label-copytight">© Archi AI 2023. All Rights Reserved.</div>
